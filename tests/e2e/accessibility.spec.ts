...
test.describe('Accessibility (WCAG 2.2)', () => {
  ...
  test('blog post has no critical accessibility violations', async ({
    page,
  }) => {
  ...
  test('archive page has no critical accessibility violations', async ({
    page,
  }) => {
    await page.goto('/archive.html');
  ...
  test('tags page has no critical accessibility violations', async ({
    page,
  }) => {
