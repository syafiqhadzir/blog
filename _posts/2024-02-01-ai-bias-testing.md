...
- **Representation Bias needs auditing**: Does your training data look like the real world?
- **Disparate Impact needs measurement**: Does the model approve 80% of Group A but only 20% of Group B?
- **Adversarial Testing reveals offence**: Try to trick the AI into being offensive. It is surprisingly easy.
...
Here is a Python function to calculate if your model is biased against a specific group.
