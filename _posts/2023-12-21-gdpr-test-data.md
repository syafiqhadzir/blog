...
Here is how to generate high-quality fake data using Python and `Faker`. Use this to seed your staging DB.
...
- **Verify**: Test the "Export My Data" (GDPR Subject Access Request) feature. Does it actually export *everything*?
