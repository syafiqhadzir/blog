...
- **FRS (Functional)**: The "How". Developer level. "The password must be 8 chars long."
- **No Docs?**: If you do not have requirements, you are not testing; you are just exploring.
...
A **Business Requirement Specification (BRS)** explains why we are building this thing in the first place.

- "Increase user retention by 5%."
- "Allow users to pay with Dogecoin (unfortunately)."

Whereas the SRS and FRS provide a roadmap for developers, the BRS provides the budget and the motivation.

## Code Snippet: Gherkin for Clarity

We can map requirements directly to tests using Cucumber/Gherkin. This links the FRS to the actual executable test.
